...
class HomeScreen extends StatelessWidget {
  ...
  final Map<String, String> questionFiles = const {
    "主星+吉凶星": "assets/data/questions.json",
    "十二宮位": "assets/data/questions_type2.json",
    "主星+吉凶星+生年四化": "assets/data/questions_type3.json",
    "主星的說話方式": "assets/data/questions_type4.json",
  };
                    ...
                    try {
                      ...
                      if (questions.isNotEmpty) {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (_) => QuizIntroScreen(questions: questions),
